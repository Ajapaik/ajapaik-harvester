    ...
    implements Serializable
{
    ...
    public boolean isSetAdminEmail() {
        return ((this.adminEmail!= null)&&(!this.adminEmail.isEmpty()));
    }
    ...
    public boolean isSetEarliestDatestamp() {
        return (this.earliestDatestamp!= null);
    }
    ...
    public boolean isSetDeletedRecord() {
        return (this.deletedRecord!= null);
    }
    ...
    public boolean isSetCompression() {
        return ((this.compression!= null)&&(!this.compression.isEmpty()));
    }
