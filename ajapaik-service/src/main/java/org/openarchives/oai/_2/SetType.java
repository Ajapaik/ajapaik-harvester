    ...
    implements Serializable
{
    ...
    public boolean isSetSetDescription() {
        return ((this.setDescription!= null)&&(!this.setDescription.isEmpty()));
    }

    public void unsetSetDescription() {
